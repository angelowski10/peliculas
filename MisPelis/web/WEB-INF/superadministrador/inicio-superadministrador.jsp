<%-- 
    Document   : adim
    Created on : 16-jul-2020, 15:16:21
    Author     : cecio
--%>
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Pelis Plus</h6>
                </div>
                <div class="card-body">
                  ...
                  <p></p>
                  <a target="_blank" rel="nofollow" href="index.html">Visitar el sitio &rarr;</a>
                </div>
              </div>
