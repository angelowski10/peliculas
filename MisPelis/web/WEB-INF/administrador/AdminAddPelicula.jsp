            ...
            <div class="card-body">
                ...
                <div class="col-md-12 strech-card">
                    <div class="col-md-12">
                        ...
                        <br>
                        <form method="post" action="AdminAddPelicula" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lanzamiento"
                                               value="" placeholder="Año de Lanzamiento"
                                               placeholder="" id="" required=""/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="genero" multiple="" class="form-control">
                                            <c:forEach var="generos" items="${generos}">
                                                <option value="${generos.idGenero}">${generos.nombre}</option>
