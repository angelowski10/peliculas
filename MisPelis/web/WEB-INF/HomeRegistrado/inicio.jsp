						...
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="PeliculaDetalle__Registrado?id=${p.idPelicula}">${p.titulo}</a></h6>							
								</div>
                                           ...
                                           <h4><p class="fexi_header">${pr.idPelicula.titulo}</p></h4>
                                                            ...
                                                            <p class="fexi_header_para"><span>Genero<label>:</label></span>
                                                                <c:forEach var="pg" items="${pr.idPelicula.generoList}">
                                                                    <a href="Generos_Registrado?id=${pg.idGenero}">${pg.nombre}</a> |
                                                                </c:forEach>
                                                            </p>
                                        </div>		
                                        <div class="clearfix"> </div>
			...
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				...
				<div id="myTabContent" class="tab-content">
					...
					<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="PeliculaDetalle__Registrado?id=${pD.idPelicula}">${pD.titulo}</a></h6>							
								</div>
					...
					<ul class="slides">
						<li>
							...
							<div class="agileinfo_flexislider_grids">
								...
								<div class="mid-1 agileits_w3layouts_mid_1_home">
                                                                    <div class="w3l-movie-text">
									<h6><a href="PeliculaDetalle__Registrado?id=${pp.idPelicula.idPelicula}">${pp.idPelicula.titulo}</a></h6>							
                                                                    </div>
                                                                    <div class="mid-2 agile_mid_2_home">
