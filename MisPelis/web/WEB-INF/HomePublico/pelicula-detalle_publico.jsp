		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
                                                    <a href="#" data-toggle="modal" data-target="#myModal"><h3>${pelicula.titulo}</h3></a>
                                                </div>
						<div class="video-grid-single-page-agileits">
                                                    <div data-video="dLmKio67pVQ" id="video"> 
                                                        <a href="#" data-toggle="modal" data-target="#myModal"><img src="imagenes/peliculas/${pelicula.imagen}" width="150" height="580" /> </a>
                                                    </div>
						</div>
					</div>
						...
						<div class="all-comments-info">
							...
							<div class="agile-info-wthree-box">
									...
									<textarea placeholder="Message" required=""></textarea>
                                                                        ...
                                                                        <a href="#" data-toggle="modal" data-target="#myModal"><input type="submit" value="SEND"></a>
									<div class="clearfix"> </div>
								</form>
							</div>
						</div>
				...
				<div id="owl-demo" class="owl-carousel owl-theme">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
                                                    <a href="PeliculaDetalle__Publico?id=${pr.idPelicula.idPelicula}" class="hvr-shutter-out-horizontal"><img src="imagenes/peliculas/${pr.idPelicula.imagen}" title="album-name" width="180" height="283" />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="PeliculaDetalle__Publico?id=${pr.idPelicula.idPelicula}">${pr.idPelicula.titulo}</a></h6>							
								</div>
