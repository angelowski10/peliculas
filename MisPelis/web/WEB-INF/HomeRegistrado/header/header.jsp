	...
	<div class="header">
		<div class="container">
			<div class="w3layouts_logo">
				<a href="Home_Registrado"><h1>Pelis<span>Plus</span></h1></a>
			</div>
			<div class="w3_search">
				<form action="Buscar_Registrado" method="get">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							<li class="active"><a href="Home_Registrado">Home</a></li>
							<li class="dropdown">
									...
									<div class="col-sm-4">
										<ul class="multi-column-dropdown">
                                                                                    <c:forEach var="g" items="${generoList}">
                                                                                        <li><a href="Generos_Registrado?id=${g.idGenero}">${g.nombre}</a></li>
                                                                                    </c:forEach>
                                                                                </ul>
									</div>
									<div class="clearfix"></div>
                                                        ...
                                                        <li><a href="ListaEstrenos_Registrado">Estrenos</a></li>
                                                        <li><a href="ListaPelicula_Registrado">A - z lista</a></li>
						</ul>
					</nav>
				</div>
			</nav>	
