		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
                                                    <a href="Pelicula?id=${pelicula.idPelicula}"><h3>${pelicula.titulo}</h3></a>
                                                </div>
						<div class="video-grid-single-page-agileits">
                                                    <div data-video="dLmKio67pVQ" id="video"> 
                                                        <a href="Pelicula?id=${pelicula.idPelicula}"><img src="imagenes/peliculas/${pelicula.imagen}" width="150" height="580" /> </a>
                                                    </div>
						</div>
					</div>
